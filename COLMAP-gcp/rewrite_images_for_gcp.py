...
parser.add_argument("-t", "--txt_outs", default="/home/zt/Project/COLMAP_GroundControlPoints-main/output/txt_outs", help = "gcp输出的txt_out")
parser.add_argument("-p", "--project_folder", help = "colmap重建项目的文件夹路径,示例/D/data/zt/project/colmap/test_with_gcp", required=True)
args = parser.parse_args()

camera_path = os.path.join(args.txt_outs,"cameras.txt")
images_path = os.path.join(args.txt_outs,"images.txt")
points3D_path = os.path.join(args.txt_outs,"points3D.txt")
